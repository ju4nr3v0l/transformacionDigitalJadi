            ...
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    <div class="d-grid gap-2">
                        <a href="/inicioConsultoria"   class="btn btn-lg btn-primary btn-form btn-landing">Iniciar Diagnóstico</a>
                    </div>
                </div>
            </div>
        </div>
